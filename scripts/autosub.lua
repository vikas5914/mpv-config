...
local subliminal = 'C:\\Users\\vikas\\scoop\\apps\\python38\\3.8.10\\Scripts\\subliminal.exe'
--=============================================================================
-->>    SUBTITLE LANGUAGE:
--=============================================================================
...
mp.add_key_binding('Alt+b', 'download_subs', download_subs)
mp.add_key_binding('Alt+n', 'download_subs2', download_subs2)
